...
type NewType = {
  [x: string]: number  // Index signature requiring all properties to be numbers
  id: number
  title: string       // Conflict: string is not assignable to number
  description: string // Conflict: string is not assignable to number
  price: number
  level: string       // Conflict: string is not assignable to number
  duration: number
  questions: any[]
  subcategory?: string // Conflict: string is not assignable to number
  category?: string    // Conflict: string is not assignable to number
  childCategory?: string // Conflict: string is not assignable to number
  rating?: number
  reviews?: number
  popularity?: number
  lastUpdated?: string // Conflict: string is not assignable to number
}

...
// import { toast } from "@/components/ui/use-toast"
// import { testCatalog } from "@/lib/test-catalog"
// import { ChevronDown, ChevronRight, Clock, Star, Filter, SlidersHorizontal, X, Building, BookOpen, Shield } from "lucide-react"
...
export default function TestsPage() {
  const router = useRouter()
  const searchParams = useSearchParams()
  const { addToCart, cartItems, purchasedTests } = <CartState className="use"></CartState>
  ...
  useEffect(() => {
    setCurrentPage(1)
  }, [searchQuery, categoryParam, subcategoryParam, childCategoryParam, sortParam, priceParam, levelParam])
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 p-4 md:p-6 bg-gray-50">
        <div className="mx-auto max-w-7xl space-y-8">
          ...
          {paginatedTests.length === 0 && (
            <div className="text-center text-gray-500">No tests found. Try adjusting your filters or search.</div>
          )}

...
// In your store types file:
interface TestState {
  purchasedTests: TestType[];
  cartItems: CartItemType[];
  // ... other test-related state
}
...
// In your component:
const { purchasedTests, cartItems } = useStore((state: RootState) => ({
  purchasedTests: state.tests.purchasedTests,
  cartItems: state.tests.cartItems
}));

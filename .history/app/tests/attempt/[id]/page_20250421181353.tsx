...
/**
 * DashboardPage displays user statistics fetched from the server,
 * presents a simple question form, and navigates to the result page
 * with the submitted answer as a query parameter.
 */
const DashboardPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    setSubmitted(true)
    // Redirect to result page with answer query parameter
    const encoded = encodeURIComponent(answer.trim())
    router.push(`/dashboard/result?answer=${encoded}`)
  }

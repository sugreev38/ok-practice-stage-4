            ...
            <div className="md:col-span-3">
              <Card className="mb-6">
                ...
                <CardContent>
                  ...
                  <RadioGroup value={answers[currentQuestion]} onValueChange={handleAnswerSelect                    {test.questions[currentQuestion].options.map((option, index) => (

...
console.log("Total Tests:", tests.allTests.length);
console.log("SSC Category Tests:", tests.categoryTests["ssc"].length);
console.log("Tier-I Child Tests:", tests.childCategoryTests["tier-i"].length);
console.log("First Tier-I Test:", tests.childCategoryTests["tier-i"][0]);

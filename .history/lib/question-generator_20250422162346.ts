...
```typescript
const questionTemplates: Record<string, any[]> = {
  // History Questions (Already completed with 10 new questions in previous response)
  history: [
  ...
  "railway-history": [
    ...
    {
      question: "Which organization manages the Indian Railways?",
      options: ["Ministry of Railways
